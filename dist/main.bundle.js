...
module.exports = "<div class=\"tab\">\n    <a class=\"tab__link\" [class.is-active]=\"selectedLink == link\" *ngFor=\"let link of links\" [routerLink]=\"['/tvs', link]\" (click)=\"selectedLink=link\">{{formateTitle(link)}}</a>\n</div>\n\n<movie-list [movies]=tvs [type]=type [list]=list [totalPages]=totalPages [currentPage]=currentPage></movie-list>"
