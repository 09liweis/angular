...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_tv_tv_component__ = __webpack_require__("./src/app/pages/tv/tv.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_22__pages_tv_tv_component__["a" /* TvComponent */],
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot([
                    ...
                    {
                        path: 'tv/:id',
                        component: __WEBPACK_IMPORTED_MODULE_22__pages_tv_tv_component__["a" /* TvComponent */]
                    },
                    {
                        path: 'movies',
...
var MovieComponent = (function () {
    ...
    MovieComponent.prototype.formateRevenue = function (revenue) {
        return revenue;
    };
...
module.exports = "<div class=\"tabs is-centered\">\n  <ul>\n      <li class=\"tab col s3\" *ngFor=\"let link of links\"><a [class.is-active]=\"selectedLink == link\" [routerLink]=\"['/persons', link]\" (click)=\"selectedLink=link\">{{link}}</a></li>\n  </ul>\n</div>\n<div class=\"columns is-mobile is-multiline\" *ngIf=\"persons\" [@personsAnimation]=\"persons.results.length\">\n  <a *ngFor=\"let p of persons.results\" class=\"person column is-6-mobile is-3-tablet is-2-desktop is-2-widescreen\">\n    <figure class=\"image\">\n      <img class=\"person__image\" src=\"https://image.tmdb.org/t/p/w500{{p.profile_path}}\" alt=\"{{ p.name }}\" />\n      <figcaption class=\"person__name\">{{p.name}}</figcaption>\n    </figure>\n  </a>\n</div>\n"
...
var PersonsComponent = (function () {
    ...
    PersonsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["n" /* Component */])({
            ...
            animations: [
                Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["l" /* trigger */])('personsAnimation', [
                    Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["k" /* transition */])('* => *', [
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["g" /* query */])(':enter', Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["i" /* stagger */])('200ms', [
                            Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["e" /* animate */])('0.3s ease', Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["f" /* keyframes */])([
                                Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["j" /* style */])({ opacity: 0, transform: 'translateX(20%)', offset: 0 }),
                                Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["j" /* style */])({ opacity: 0.5, transform: 'translateX(-20px)', offset: 0.5 }),
                                Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["j" /* style */])({ opacity: 1, transform: 'translateX(0)', offset: 1 }),
                            ]))
                        ]), { optional: true })
                    ])
                ])
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["d" /* Title */],
            __WEBPACK_IMPORTED_MODULE_4__services_person_service__["a" /* PersonService */],
            __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]])
    ], PersonsComponent);
