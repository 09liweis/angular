...
module.exports = "<div class=\"tab\">\n    <a class=\"tab__link\" [class.is-active]=\"selectedLink == link\" *ngFor=\"let link of links\" (click)=\"gotoLink(link)\">{{formateTitle(link)}}</a>\n</div>\n\n<movie-list [movies]=movies [type]=type [list]=list [totalPages]=totalPages [currentPage]=currentPage></movie-list>\n"
...
var MoviesComponent = (function () {
    function MoviesComponent(titleService, movieService, route, router) {
        this.titleService = titleService;
        this.movieService = movieService;
        this.route = route;
        this.router = router;
...
module.exports = "<div class=\"tab\">\n    <a class=\"tab__link\" [class.is-active]=\"selectedLink == link\" *ngFor=\"let link of links\" [routerLink]=\"['/tvs', link]\" (click)=\"gotoLink(link)\">{{formateTitle(link)}}</a>\n</div>\n\n<movie-list [movies]=tvs [type]=type [list]=list [totalPages]=totalPages [currentPage]=currentPage></movie-list>"
...
var TvsComponent = (function () {
    function TvsComponent(titleService, tvService, route, router) {
        this.titleService = titleService;
        this.tvService = tvService;
        this.route = route;
        this.router = router;
