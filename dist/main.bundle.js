...
module.exports = "<div class=\"tabs is-centered\">\n    <ul>\n        <li class=\"tab col s3\" [class.is-active]=\"selectedLink == link\" *ngFor=\"let link of links\"><a class=\"tab__link\" [routerLink]=\"['/movies', link]\" (click)=\"selectedLink=link\">{{formateTitle(link)}}</a></li>\n    </ul>\n</div>\n\n<movie-list [movies]=movies [type]=type [list]=list [totalPages]=totalPages [currentPage]=currentPage></movie-list>\n"
